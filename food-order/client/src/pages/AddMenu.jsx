...
function AddMenu() {
  ...
  // select and optionlarda tavuk menu

  //sıra:6 dipstach obje oluturup göndericez. burgeractiona gidiyoruz. ekleme işlemini test ettik menu geldi silme işlemide calısıyor.
