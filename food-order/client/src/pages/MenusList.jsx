...
function MenusList() {
  ...
  //sıra:1) , [burgers]);  burgers a baksın güncelleme varsa  getallburgersi cagiriıp güncelleme yapıcak.seewtalert2  den are your sure? swall.fire aldık .sıra:4 ${burger._id} yazdık sonra AddMenu page tasarımını gittik.
...
//<Link to={`/admin/editmenu/5`}>  5 yerine ${id} yazicaz o edit  sayfasına gidicek.
